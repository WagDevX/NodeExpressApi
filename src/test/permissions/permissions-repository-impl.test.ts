...
describe("Permissions Repository", () => {
  ...
  describe("Create Permission", () => {
    test("should call the data source and return a true promise", async () => {
      ...
      jest
        .spyOn(mockPermissionsDataSource, "createPermission")
  ...
  describe("Update Permission", () => {
    test("should call the data source and return a true promise", async () => {
      ...
      jest
        .spyOn(mockPermissionsDataSource, "updatePermission")
        .mockImplementation(() => Promise.resolve());

      const result = await mockRepository.updatePermission(
        permission.id,
        permission
      );
  ...
  describe("Get Permissions", () => {
    test("should call the data source and return list of permissions", async () => {
      ...
      jest
        .spyOn(mockPermissionsDataSource, "getPermissions")
