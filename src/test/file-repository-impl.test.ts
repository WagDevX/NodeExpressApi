...
describe("FileRepositoryImpl", () => {
    ...
    describe("createFile", () => {
        test("should call createFile from dataSource", async () => {
            ...
            jest.spyOn(mockDataSource, "createFile").mockImplementation(() => Promise.resolve());
    ...
    describe("moveFile", () => {
        test("should call moveFile from dataSource", async () => {
            jest.spyOn(mockDataSource, "moveFile").mockImplementation(() => Promise.resolve());
    ...
    describe("renameFile", () => {
        test("should call renameFile from dataSource", async () => {
            jest.spyOn(mockDataSource, "renameFile").mockImplementation(() => Promise.resolve());
    ...
    describe("findFileByFolder", () => {
        test("should call findFileByFolder from dataSource", async () => {
            jest.spyOn(mockDataSource, "findFileByFolder").mockImplementation(() => Promise.resolve(fakeFile));
    ...
    describe("deleteFile", () => {
        test("should call deleteFile from dataSource", async () => {
            jest.spyOn(mockDataSource, "deleteFile").mockImplementation(() => Promise.resolve());
